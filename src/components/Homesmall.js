...
export default function Homesmall() {
    return (
        <div className="homepage phone p-b-0">
            <div className="lansec1">
                <div className="kisvg">
                    ...
                    <svg className="ab-c-m" width="240" height="240" viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <filter id="filterq0_d" x="0" y="0" width="240" height="240" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                            ...
                            <linearGradient id="paint0_linearaa" x1="115" y1="55" x2="115" y2="175.025" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#0066FF" />
                                <stop offset="1" stopColor="#49A1EE" />
                            </linearGradient>
                            <linearGradient id="paint1_linearab" x1="115" y1="55" x2="115" y2="175.025" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#0066FF" />
                                <stop offset="1" stopColor="#49A1EE" />
                            </linearGradient>
                            <linearGradient id="paint2_linearac" x1="115" y1="55" x2="115" y2="175.025" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#0066FF" />
                                <stop offset="1" stopColor="#49A1EE" />
                            </linearGradient>
                            <linearGradient id="paint3_linearad" x1="115" y1="55" x2="115" y2="175.025" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#0066FF" />
                                <stop offset="1" stopColor="#49A1EE" />
                            </linearGradient>
                            <linearGradient id="paint4_linearae" x1="115" y1="55" x2="115" y2="175.025" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#0066FF" />
                                <stop offset="1" stopColor="#49A1EE" />
                            </linearGradient>
                        </defs>
