...
document.onpointerdown = function (event) {
  ...
  if (!target || !target.classList || !target.classList.contains("ripple"))
    return;
...
$(".sidelink").click(function () {
  $(".hamburger-svg").removeClass("opened");
  $("#smallsidebar").removeClass("expanded");
  $(".sidebar-overlay").removeClass("expanded");
