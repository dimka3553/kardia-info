            ...
            <div className="clubhouse">
                <div className="icoWarapper">
                    <div className="top m-b-100">
                        <p className="p-t-0 m-t-0 p-l-40 m-b-24 fs-24 t-ab icot">INFO Clubhouse stats</p>
                            ...
                            <div className="ch-overlay">
                                <div>
                                    ...
                                    <p className="fs-18 t-g m-b-40 fw-100">
                                        Luxury INFO buyers club - Stake INFO to receive Club INFO that can be swapped back for INFO at any time.
                                    </p>
                                </div>
                                <div className="ch-info">
                                    ...
                                    <div className={"stakemore fs-16 t-g " + this.state.morebtns}>
                                        ...
                                        <span onClick={this.toggleUnstakeModal} className="t-g c-pointer">Unstake INFO</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="swapbox">
                            ...
                            <div className="gameinput pos-r m-b-16">
                                <div className="tophalf m-b-5">
                                    ...
                                    <span className="fs-14 f-ws t-bl c-pointer" onClick={this.handleMaxSwap}>Balance: {numberWithCommas(parseFloat(this.state.cinfoBal).toFixed(2))} cINFO</span>
                                </div>
                                <div className="inpboxg">
                                    ...
                                    <span className="ab-r-m m-r-10 fs-16 f-ws">cINFO</span>
                                </div>
                            </div>
                            <p className="t-g f-ws fs-12 m-t-0 m-b-16">
                                Rate: {this.state.rate.toFixed(6)} cINFO / INFO
                            </p>
                            <hr />
