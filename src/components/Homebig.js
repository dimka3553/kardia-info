    ...
    return (
        <div className="hpwrapper big">
                ...
                <div className="topsec">
                    <div className="left">
                        <div className="textdiv ab-l-m m-l-70">
                            <h1 className="fs-48 fw-600">Get the latest KardiaChain<br /> stats in one place</h1>
                            <p className="hp-g fs-18 lh-1-8"> With Kardia info - you will have quick access to information regarding all things kardiachain.</p>
                            <br />
                            <br />
                            <br />
                            <Link className="t-d-none" to="/tokens">
                                <button className="hpbtn-bl m-r-15 c-pointer">View Tokens</button>
                            </Link>
                            <Link className="t-d-none" to="/lps">
                                <button className="hpbtn-tr c-pointer">View Pairs</button>
                            </Link>
            ...
            <div className="bluesec">
                <div className="midwid">
                    <div className="m-b-50">
                        <h1 className="fs-40 fw-700 txt-c">
                        ...
                        <Link className="t-d-none " to="/tokens">
                            <button className="hpbtn-tr-svg c-pointer m-r-auto m-l-auto d-block">View more
                            ...
                            <div className="hp-tok-sec m-b-22">
                                <div className="d-flex al-c">
                                    ...
                                    <div className="hp-name">
                                        ...
                                        <p className="m-b-0 fw-400 fs-20 t-s m-t-0">{props.tokens[0].name}</p>
                                    </div>
                                </div>
                                <div className="d-flex al-c">
                                    <div className="hp-price">
                                        <p className="fw-600 fs-24">${(props.tokens[0].price).toFixed(4)}</p>
                                    </div>
                                    <div className="hp-change m-l-40 txt-r p-r-15">
                                        <p className={"fs-23 " + props.col[0]}>{(props.tokens[0].dayChange).toFixed(2)}%</p>
                                    </div>
                                </div>
                            </div>
                        </Link>
                            ...
                            <div className="hp-tok-sec shad m-b-22">
                                <div className="d-flex al-c">
                                    ...
                                    <div className="hp-name">
                                        ...
                                        <p className="m-b-0 fw-400 fs-20 t-s m-t-0">{props.tokens[props.ran[1]].name}</p>
                                    </div>
                                </div>
                                <div className="d-flex al-c">
                                    <div className="hp-price">
                                        <p className="fw-600 fs-24">${(props.tokens[props.ran[1]].price).toFixed(4)}</p>
                                    </div>
                                    <div className="hp-change m-l-40 txt-r p-r-15">
                                        <p className={"fs-23 " + props.col[props.ran[1]]}>{(props.tokens[props.ran[1]].dayChange).toFixed(2)}%</p>
                                    </div>
                                </div>
                            </div>
                        </Link>
                            ...
                            <div className="hp-tok-sec m-b-150">
                                <div className="d-flex al-c">
                                    ...
                                    <div className="hp-name">
                                        ...
                                        <p className="m-b-0 fw-400 fs-20 t-s m-t-0">{props.tokens[props.ran[2]].name}</p>
                                    </div>
                                </div>
                                <div className="d-flex al-c">
                                    <div className="hp-price">
                                        <p className="fw-600 fs-24">${(props.tokens[props.ran[2]].price).toFixed(4)}</p>
                                    </div>
                                    <div className="hp-change m-l-40 txt-r p-r-15">
                                        <p className={"fs-23 " + props.col[props.ran[2]]}>{(props.tokens[props.ran[2]].dayChange).toFixed(2)}%</p>
                                    </div>
                                </div>
            ...
            <div className="whitesec">
                <div className="secti">
                    <div className="left">
                        <div className="sectxt m-l-50">
                            <h1 className="fs-40 fw-700">Kardia info Telegram bot</h1>
                            <p className="fs-18 hp-g lh-1-7">Get the latest info with a simple message in PMs or Group chats. already avialable in numerous Group chats in the kardiachain community.</p>
                            <br />
                            <a href="https://t.me/Kardia_info_bot">
                                <button className="hpbtn-tr-svg c-pointer">Message the Ki bot
                ...
                <div className="secti">
                    <div className="left">
                        <Oraclesvg cn="ab-c-b m-b-35" />
                    </div>
                    <div className="right">
                        <div className="sectxt m-l-50">
                            <h1 className="fs-40 fw-700">Kardia Info Oracle</h1>
                            <p className="fs-18 hp-g lh-1-7">The backend service for kardiainfo allows for very quick loading times and the ability to fetch historical price data for each KRC-20 token with just 1 request for both smart contracts and Apps.</p>
                            <br />
                            <a href="https://docs.kardiainfo.com/features-and-services/info-oracle-api-v1">
                                <button className="hpbtn-tr-svg c-pointer">View the docs
                                    <svg className="ab-r-m m-r-20" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10 16.0003L14 12.0003L10 8.00037" stroke="#226BF6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </button>
                ...
                <div className="secti">
                    <div className="left">
                        <div className="sectxt m-l-50">
                            <h1 className="fs-40 fw-700">Info Token</h1>
                            <p className="fs-18 hp-g lh-1-7">A token filled with use cases that do not yet exist anywhere in the DeFi world. Sound tokenomics that create deflation and maximum incentive to hold.</p>
                            <br />
                            <a href="https://docs.kardiainfo.com/about-kardia-info/info-token-info">
                                <button className="hpbtn-tr-svg c-pointer">Learn more
                                    <svg className="ab-r-m m-r-20" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10 16.0003L14 12.0003L10 8.00037" stroke="#226BF6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </button>
                ...
                <div className="secti">
                    ...
                    <div className="right">
                        <div className="sectxt m-l-50">
                            <h1 className="fs-40 fw-700">Kardia Info Game</h1>
                            <p className="fs-18 hp-g lh-1-7">An amazing use case for the Info Token. This game allows you to multiply your bet by up to x4750. Or to stake and receive a portion of the revenue generated by the game.</p>
                            <br />
                            <a href="https://kardiainfo.com/game"><button className="hpbtn-bl m-r-15 c-pointer">Play the Game</button></a>
